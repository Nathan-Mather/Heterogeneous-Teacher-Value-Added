...
#======================================#
  ...
  #'@param teacher_va_epsilon SE of normal distribution adding noise to how teahcer ability translates into studnet growth 
  #'@param teacher_abiliy_drop_off This dictates how quickly teacher ability falls as a student moves away from a
  ...
  simulate_test_data <- function(n_schools               = 20,
    ...
    r_dt[, teacher_impact := teacher_ability - abs(stud_ability_1 - teacher_center)* teacher_abiliy_drop_off]
