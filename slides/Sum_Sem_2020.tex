...
\begin{wideitemize}
    ...
    \vfill
    \item \textbf{How much does teacher value added vary across the achievement distribution?} %We are intersted in this within and across teachers right?
    \vspace{-14pt}
    \vspace{5mm}
...
%----------------------------------
% Method three: Quantile Regression
%--------------------------------------
