 ...
 \begin{figure}[H]
   ...
   \begin{subfigure}[b]{0.45\textwidth}
    ...
    \end{subfigure}
     \begin{subfigure}[b]{0.45\textwidth}
    \subcaption[]{ELA Gaps}
        \includegraphics[width=1\textwidth]{Working_Paper/WP_Figures/ela_gaps.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
    \subcaption[]{ELA Gaps}
        \includegraphics[width=1\textwidth]{Working_Paper/WP_Figures/college_parent_gap.png}
    \end{subfigure}
