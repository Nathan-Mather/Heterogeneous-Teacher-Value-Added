...
\scalebox{.8}{
    \input{slides/Figures/sum_stats_Linear}
}
\end{frame}
...
\scalebox{.8}{
    \input{slides/Figures/sum_stats_rawlsian}
}
\end{frame}
...
\scalebox{.8}{
    \input{slides/Figures/sum_stats_Kernal}
}
\end{frame}
...
\begin{figure}
    \includegraphics[width=.3\textwidth,height=.35\textheight]{slides/Figures/st_rawlsian_Students_30_caterpillar.png}\hfill
    \includegraphics[width=.3\textwidth,height=.35\textheight]{slides/Figures/st_rawlsian_Students_100_caterpillar.png}\hfill
    \includegraphics[width=.3\textwidth,height=.35\textheight]{slides/Figures/st_rawlsian_Students_200_caterpillar.png}\hfill
    \\ \vspace{1em}
    \includegraphics[width=.3\textwidth,height=.35\textheight]{slides/Figures/ww_rawlsian_Students_30_caterpillar.png}\hfill
    \includegraphics[width=.3\textwidth,height=.35\textheight]{slides/Figures/ww_rawlsian_Students_100_caterpillar.png}\hfill
